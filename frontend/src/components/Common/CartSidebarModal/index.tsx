        ...
        <div className="w-full max-w-[500px] shadow-1 bg-white px-4 sm:px-7.5 lg:px-11 relative modal-content">
          ...
          <div className="border-t border-gray-3 bg-white pt-5 pb-4 sm:pb-7.5 lg:pb-11 mt-7.5 sticky bottom-0">
            ...
            <div className="flex flex-col gap-4">
              {checkoutError && (
                <p className="text-red text-custom-sm">{checkoutError}</p>
              )}
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="w-full flex justify-center font-medium text-white bg-dark py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-opacity-95 disabled:opacity-50 disabled:cursor-not-allowed"
                >
