...
import CartBackendItem from "./CartBackendItem";
    ...
    <>
      ...
      {loading ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 text-center text-dark-4">
            Loading cart...
          </div>
        </section>
      ) : hasItems ? (
            ...
            <div className="bg-white rounded-[10px] shadow-1">
              <div className="w-full overflow-x-auto">
                <div className="min-w-[1170px]">
                  ...
                  {/* <!-- cart item --> */}
                  {cartItems.map((item) => (
                    <CartBackendItem item={item} key={item.id} />
                  ))}
                </div>
              </div>
            </div>
