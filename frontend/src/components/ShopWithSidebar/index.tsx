...
type ShopWithSidebarProps = {
  /** When provided (e.g. from SSR), use these products instead of static shopData */
  products?: Product[];
  /** Last segment of breadcrumb (e.g. "Shop" for /shop page) */
  breadcrumbCurrent?: string;
};

const ShopWithSidebar = ({
  products: productsProp,
  breadcrumbCurrent = "shop with sidebar",
}: ShopWithSidebarProps) => {
  const products = productsProp ?? shopData;
